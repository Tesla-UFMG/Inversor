...
#define VARIABLES_GENERAL_CAN_TX                                                         \
    ...
    CAN_GENERAL_LIST_DATA(ID_TEMP_AR_INTER_L_MOTOR, 85, 2)                                       \
    CAN_GENERAL_LIST_DATA(ID_CURRENT_L_MOTOR, 85, 3)                                     \
    CAN_GENERAL_LIST_DATA(ID_LAST_FAILURE_L_MOTOR, 86, 0)                                      \
    ...
    CAN_GENERAL_LIST_DATA(ID_TEMP_AR_INTER_R_MOTOR, 95, 2)                                       \
    CAN_GENERAL_LIST_DATA(ID_CURRENT_R_MOTOR, 95, 3)                                     \
    CAN_GENERAL_LIST_DATA(ID_LAST_FAILURE_R_MOTOR, 96, 0)                                      \
